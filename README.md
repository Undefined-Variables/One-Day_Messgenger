...
FireBase free limits are 100 connections to cloud databse and 1GB per month. 

We’re going to build an application called "One-Day_I_Woke". It will allow authenticated users to send and read messages and users can sign up by providing their email and creating a password, or by authenticating via Google or GitHub using oAuth.
